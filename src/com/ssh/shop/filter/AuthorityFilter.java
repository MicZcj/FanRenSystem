...
@WebFilter(filterName = "authorityFilter", urlPatterns = { "/*" }, initParams = {
		...
		@WebInitParam(name = "proLogin", value = "boss_login.action") })
public class AuthorityFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (session.getAttribute("existBoss") == null && !requestPath.endsWith(loginPage)
				&& !requestPath.endsWith(proLogin) && !requestPath.contains("assets")
