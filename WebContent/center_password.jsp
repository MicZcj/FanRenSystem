...
<body>
	...
	<div class="container">
		<div align="center">
			<div class="row">
				<h1>${existBoss.bossName}</h1>
				<br>
				<form action="boss_password.action" method="post">
					<table border="0" height="200px">
						<tr>
							<td>旧密码</td>
							<td><input type="hidden" name="bossID"
								value="${session.existBoss.bossID}"><input type="hidden"
								name="bossName" value="${session.existBoss.bossName}"><input
								id="bossPassword" name="bossPassword" class="form-control"
